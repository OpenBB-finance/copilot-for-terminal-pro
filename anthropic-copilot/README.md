# Anthropic Copilot
This example provides an Anthropic-powered copilot that uses the `claude-3-opus`
LLM. The context limit is 200k tokens.
...
Python, as well as your Anthropic API key.
...
Terminal Pro interacts with copilots to verify that your Copilot is
running correctly.
